...
CREATE TABLE IF NOT EXISTS client_version_config (
    ...
    cdn_main_url              TEXT         NOT NULL,
    cdn_fallback_url          TEXT,
    resource_manifest_url     TEXT,
...
(
    'your_game', 'official', 'android', 'cn',
    '1.0.0', 10000, 10000, false, NULL,
    '2026.01.01.1', 'DefaultPackage',
    'https://cdn1.example.com/your_game/android/cn/v2026.01.01.1/',
    'https://cdn2.example.com/your_game/android/cn/v2026.01.01.1/',
    NULL,
    'active', 100
)
